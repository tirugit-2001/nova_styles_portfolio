...
// import type { PortfolioAdminModel } from '../../../Admin/AdminComponents/PortfolioAdmin';

const PortfolioWork = () => {
  const [selectedCategory, setSelectedCategory] = useState('All');
  // const [portfolioItems, setPortfolioItems] = useState<PortfolioAdminModel[]>([]);
  ...
  // useEffect(() => {
  //   const handleStorageChane = () => {
  //     const updated = localStorage.getItem("portfolioData");
  //     if(updated) setPortfolioItems(JSON.parse(updated))
  //   }
  // window.addEventListener("storage", handleStorageChane);
  // return () => window.removeEventListener("storage", handleStorageChane);
  // })
